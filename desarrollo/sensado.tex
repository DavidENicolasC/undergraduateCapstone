...
La Figura \ref{fig:calibracion} muestra el proceso de calibración del sensor para cada eje, donde $X(kT)$  es la entrada deseada de 0 para todos los ejes del giroscopio y el acelerómetro, excepto el eje Z, por lo ya antes mencionado, y $Y(kT)$ es la salida de la medición en dicho eje después de aplicar el nuevo offset. Para corregir los offsets, se aplicó el control PI.
