...
Con base en lo anterior se generaron los datos, de modo que cada posición alcanzable agrupara un conjunto de combinaciones de longitudes y ángulos de inclinación que permiten alcanzar dicha posición. Se agruparon las posiciones de acuerdo con una de las posiciones.