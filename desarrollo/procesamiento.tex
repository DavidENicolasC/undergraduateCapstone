...
\begin{itemize}
	...
	\item $alpha_1, alpha_2, alpha_3 \in \mathbb{Z}$; El ángulo de la base $ 0 \leq alpha_1 \leq 360$, mientras que los ángulos de inclinación de las articulaciones $ 0 \leq alpha_2, alpha_3 \leq 90; alpha_2, alpha_3$
