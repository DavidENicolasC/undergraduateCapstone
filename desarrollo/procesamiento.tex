...
\begin{itemize} 
	...
	\item $\alpha_1, \alpha_2, \alpha_3 \in \mathbb{Z}$; El ángulo de la base es $ 0 \leq \alpha_1 \leq 360$, Los ángulos de rotación de los eslabones son $ 0 \leq \alpha_2, \alpha_3 \leq 90$
