...
\begin{itemize}
	...
	\item Las posiciones alcanzables $P = (x, y, z)$ son tales que $x,y,z \ in \mathbb{Z}$ 
	
	\item Si $L$ es cualquiera de las longitudes $L_1$ o $L_2$ y $alpha$ es cualquiera de las longitudes $alpha_1$ o $alpha_2$, entonces, para $1 \leq L \leq 7$, $$
