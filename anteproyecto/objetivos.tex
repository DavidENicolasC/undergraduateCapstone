...
\begin{itemize}
	...
	\item Implementar la comunicación entre la Raspberry Pi y el software SettDev por medio de sockets TCP en C++ y C\# para enviar los ángulos de inclinación calculados al software, guardar los datos y permitir reproducirlos en la simulación en 3D de un brazo robótico.
