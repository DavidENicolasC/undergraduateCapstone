...
Desarrollar e implementar un sistema de control utilizando una Raspberry Pi, sensores inerciales y una red neuro-difusa, para resolver la cinemática  inversa que controle la posición del efector final de un brazo robótico de 2 DoF de longitud variable.
