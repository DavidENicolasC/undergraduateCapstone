...
Para la maxima longitud $L = 21$ cm, $d_{cuerda} = 0,017 \cdot 21 = 0,36$ cm. Esa es la máxima distancia euclidiana en la que varía la posición del brazo si cambiamos en un grado alguna articulación. La métrica de posicionamiento euclidiano reveló que 
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.4]{brazoSEDPC.jpg}
