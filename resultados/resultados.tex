...
El resultado de la métrica de la desviación de la posición final, tomando el máximo valor con $L = 21 cm$, es de 0,35 cm.

La máxima resolución $L = 21$ cm, $d_{cuerda} = 0,017 \cdot 21 = 0,36$ cm. Esa es la resolución de los motores.
